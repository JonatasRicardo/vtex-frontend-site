...
import SizeBox from "../blocks/SizeBox";
import Button from "../blocks/Button";
import Modal from '../blocks/Modal';
import ContactForm, { FormFields } from '../blocks/ContactForm';
import { useState } from 'react';

export default function Contact() {
    const [showModal, setShowModal] = useState(false);
    const [contact, setContact] = useState<FormFields>();
    ...
    const handleContactFormChange = (fields: FormFields) => {
        setContact(fields);
    }
    ...
    return (
        ...
        <div className="bg-sky w-full py-10 flex justify-center lg:pt-10">
            <div className="container flex justify-center">
                ...
                <SizeBox className="w-full m-4 lg:w-8/12 xl:w-6/12">
                    ...
                    <div className="">
                        ...
                        <div className="flex flex-col lg:flex-row items-center lg:items-stretch justify-center w-full lg:py-6">
                            <div className="w-full lg:w-5/12">
                                ...
                                <Button color="navy" className="hidden lg:block shadow-none h-full w-full lg:px-4">
                                    Solicitar Contato
                                </Button>
                            </div>
        ...
        <Modal
            ...
            footer={(
                <Button color="navy" className="shadow-none h-full w-full lg:px-4">
                    Solicitar Contato
                </Button>
            )}
        >
